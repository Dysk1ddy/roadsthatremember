...
- playable Act 1 overworld routing through `Iron Hollow`, `Blackglass Well`, hidden `Cinderfall Ruins`, `Red Mesa Hold`, `Ashfall Watch`, `Duskmere Manor`, and `Emberhall Cellars`
...
- playable local maps for `Stonehollow Dig`, `Broken Prospect`, `South Adit`, `Resonant Vault Outer Galleries`, `Blackglass Causeway`, and the `Meridian Forge`
