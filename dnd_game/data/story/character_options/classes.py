...
CLASSES = {
    ...
    "Mage": {
        ...
        "armor": Armor(name="Warded Coat", base_ac=11, armor_type="light", defense_percent=5, defense_cap_percent=45),
        "shield": False,
        "features": ["mage_charge", "mage_focus", "minor_channel", "pattern_read", "ground", "focused_eye"],
        "resources": {},
