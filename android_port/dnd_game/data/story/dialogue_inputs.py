...
DIALOGUE_INPUTS: list[dict[str, object]] = [
    {
        "id": "dialogue_input_bryn_iron_hollow_arrival_insight",
        "topic_keys": ["iron_hollow_arrival_insight"],
        "scene_keys": ["iron_hollow_hub"],
        "max_act": 1,
    ...
    {
        "id": "dialogue_input_elira_iron_hollow_arrival_insight",
        "topic_keys": ["iron_hollow_arrival_insight"],
        "scene_keys": ["iron_hollow_hub"],
        "max_act": 1,
    ...
    {
        "id": "dialogue_input_rhogar_iron_hollow_arrival_persuasion",
        "topic_keys": ["iron_hollow_arrival_persuasion"],
        "scene_keys": ["iron_hollow_hub"],
        "max_act": 1,
    ...
    {
        "id": "dialogue_input_tolan_iron_hollow_arrival_persuasion",
        "topic_keys": ["iron_hollow_arrival_persuasion"],
        "scene_keys": ["iron_hollow_hub"],
        "max_act": 1,
    ...
    {
        "id": "dialogue_input_kaelis_iron_hollow_arrival_investigation",
        "topic_keys": ["iron_hollow_arrival_investigation"],
        "scene_keys": ["iron_hollow_hub"],
        "max_act": 1,
    ...
    {
        "id": "dialogue_input_bryn_iron_hollow_arrival_investigation",
        "topic_keys": ["iron_hollow_arrival_investigation"],
        "scene_keys": ["iron_hollow_hub"],
        "max_act": 1,
        "requires_companions": ["bryn_underbough"],
    ...
    },
    {
        ...
        "scene_keys": ["greywake_survey_camp"],
        "min_act": 2,
        "requires_companions": ["kaelis_starling"],
        "priority": 94,
        "lines": [
    ...
    {
        "id": "dialogue_input_nim_blackglass_entry",
        "topic_keys": ["act2_blackglass_entry"],
        "scene_keys": ["blackglass_causeway"],
        "min_act": 2,
        "requires_companions": ["nim_ardentglass"],
        "priority": 92,
        "lines": [
    ...
    {
        "id": "dialogue_input_elira_blackglass_entry",
        "topic_keys": ["act2_blackglass_entry"],
        "scene_keys": ["blackglass_causeway"],
        "min_act": 2,
        "requires_companions": ["elira_dawnmantle"],
