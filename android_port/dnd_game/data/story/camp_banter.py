...
CAMP_BANTERS: list[dict[str, object]] = [
    ...
    },
    {
        ...
        "requires_any_flags": ["blackglass_well_cleared", "greywake_triage_yard_seen", "hushfen_truth_secured"],
        "priority": 74,
        ...
        "lines": [
            ...
            ("elira_dawnmantle", "I used to think silence was where faith rested. Now I think it is where fear hides its shoes."),
            {
                ...
                "requires_flags": ["blackglass_well_cleared"],
            },
            {
                "speaker": "elira_dawnmantle",
    ...
    },
    {
        ...
        "requires_any_flags": ["iron_hollow_council_seen", "marked_keg_resolved"],
        "priority": 72,
    ...
    {
        "id": "camp_banter_bryn_kaelis_duskmere_eye",
        "title": "Secrets With Teeth",
        "participants": ["bryn_underbough", "kaelis_starling"],
        "requires_flags": ["duskmere_nothic_route"],
        "priority": 66,
        ...
        "lines": [
            ...
            ("kaelis_starling", "You are welcome."),
            {
                ...
                "requires_flag_values": {"duskmere_nothic_route": "bargain"},
            },
            {
                "speaker": "bryn_underbough",
            ...
            },
            {
                ...
                "requires_flag_values": {"duskmere_nothic_route": "kill"},
            },
            {
                "speaker": "kaelis_starling",
        ...
        "effects": [
            ...
            {
                "requires_any_flag_values": {"duskmere_nothic_route": ["bargain", "trade"]},
                "flag_increments": {"act2_bonus_whisper_pressure": 1},
            },
        ],
    },
    ...
    },
    {
        ...
        "requires_any_flags": ["broken_prospect_cleared", "resonant_vault_outer_cleared"],
        "priority": 52,
