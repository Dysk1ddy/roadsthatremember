    ...
    def scene_act2_expedition_hub(self) -> None:
        ...
        while True:
            ...
            if (
                ...
                and not self.state.flags.get("resonant_vault_outer_cleared")
            ):
                options.append(("outer", self.action_option("Advance through Resonant Vaults' outer galleries.")))
            if self.state.flags.get("resonant_vault_outer_cleared") and not self.state.flags.get("blackglass_crossed"):
                options.append(("causeway", self.action_option("Cross the Blackglass causeway.")))
            if self.state.flags.get("blackglass_crossed") and not self.state.flags.get("caldra_defeated"):
            ...
            if selection_key == "wood":
                ...
                self.travel_to_act2_node("greywake_survey_camp")
                return
            ...
            if selection_key == "outer":
                ...
                self.travel_to_act2_node("resonant_vault_outer_galleries")
                return
            if selection_key == "causeway":
                self.run_dialogue_input("act2_hub_causeway")
                self.travel_to_act2_node("blackglass_causeway")
                return
            ...
            if selection_key == "forge":
                ...
                self.travel_to_act2_node("meridian_forge")
                return
